...
context.Employees.AddAsync(new() { Name = "Ali", Surname = "Bahşi" });
context.Employees.AddAsync(new() { Name = "Berk", Surname = "Öztürk" });
context.Customers.AddAsync(new() {Name = "Mustafa"});
